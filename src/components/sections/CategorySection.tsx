        ...
        <section className="w-full">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-5 sm:grid-cols-3 lg:grid-cols-6">
                {categories.map((category) => (
                    <div
                        key={category.title}
                        className="w-full max-w-[180px] h-auto aspect-[180/238] rounded-[14px] border border-white/40 bg-[#FFFFFFB2] p-[8px] shadow-[0px_4px_16px_rgba(38,123,220,0.08)] mx-auto"
                    >
                        {/* Inner Card */}
                        <div className="card-animated-border rounded-[16px] p-[2px] h-full cursor-pointer">
                            <div
                                className="relative flex h-full w-full flex-col items-center justify-between rounded-[15px] p-3"
                                style={{
                                    background:

...
export default function BonusCategoryClient({
  initialData,
  slug,
}: {
  initialData: any;
  ...
  return (
    <div className="overflow-x-hidden w-full">
      ...
      <FAQSection 
        ...
        title={`Frequently Asked Questions about ${category?.name || 'Casino Bonuses'}`}
        pageUrl={`https://casinoreviewsbook.com/bonuses/${category?.slug || slug || ''}`}
      />

    ...
    <main className="min-h-screen ">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center  mx-auto space-y-4">
            ...
            <p className="text-base sm:text-lg text-[#475569] leading-relaxed font-normal">
              At Casino Reviews Book, player safety comes before commercial
              interest. Gambling should remain a controlled form of
              entertainment—never a financial solution or alternative income
              source.
            </p>

            <div className="pt-4 flex flex-wrap justify-center gap-6 text-xs font-semibold text-[#475569]">
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="w-4 h-4 text-[#00B67A]" /> Independent
                Auditing
              </span>
              <span className="flex items-center gap-1.5">
                <Lock className="w-4 h-4 text-[#2E68FB]" /> Strict 18+
                Verification
              </span>
              <span className="flex items-center gap-1.5">
                <HeartHandshake className="w-4 h-4 text-amber-600" /> Free
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-[#0F172A]">
                Need Immediate Help or Confidential Advice?
              </h3>
              <p className="text-xs sm:text-sm text-[#64748B] mt-1">
                If you or someone you know is struggling with gambling
                addiction, free and confidential support is available 24/7.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="p-6 rounded-2xl bg-white border border-gray-200/90 shadow-sm space-y-3">
            ...
            <p className="text-xs text-[#64748B] leading-relaxed">
              Never gamble money allocated for essential living costs such as
              rent, bills, groceries, or savings. Decide a disposable limit
              before playing.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white border border-gray-200/90 shadow-sm space-y-3">
            ...
            <h3 className="font-bold text-base text-[#0F172A]">
              Cap Your Playing Time
            </h3>
            <p className="text-xs text-[#64748B] leading-relaxed">
              Track how long you play. Set alarms or use platform session
              reminders to avoid losing track of time and extending sessions
              unnecessarily.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white border border-gray-200/90 shadow-sm space-y-3">
            ...
            <p className="text-xs text-[#64748B] leading-relaxed">
              Trying to win back lost money usually leads to further losses.
              Accept that losses are a cost of entertainment and walk away.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white border border-gray-200/90 shadow-sm space-y-3">
            ...
            <h3 className="font-bold text-base text-[#0F172A]">
              Do Not Play Distracted
            </h3>
            <p className="text-xs text-[#64748B] leading-relaxed">
              Never gamble when under the influence of alcohol or drugs, or when
              experiencing extreme emotional distress, anger, or depression.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="bg-white border border-gray-200/90 rounded-3xl p-8 sm:p-12 shadow-sm">
          <div className="max-w-3xl mb-8">
            ...
            <p className="mt-2 text-xs sm:text-sm text-[#64748B] leading-relaxed">
              Answering these quick questions can help you evaluate whether your
              gambling habits are remaining within healthy boundaries.
            </p>
          </div>
              ...
              >
                ...
                <div className="flex items-center gap-3 shrink-0">
                  <button
                    ...
                    className={`h-8 px-4 rounded-lg text-xs font-bold transition ${
                      answers[idx] === true
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-4 text-[#475569] text-base">
              As part of our rating system, we heavily penalize or blacklist
              operators that do not offer accessible self-limitation and
              exclusion tools.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 rounded-2xl bg-[#F8FAFC] border border-gray-200/90 space-y-3">
              ...
              <h3 className="font-bold text-lg text-[#0F172A]">
                Deposit & Wager Limits
              </h3>
              <p className="text-xs text-[#64748B] leading-relaxed">
                Allows players to cap daily, weekly, or monthly deposit
                ceilings. Decreases take effect instantly, while limit increases
                require a 24-hour cooling-off period.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-[#F8FAFC] border border-gray-200/90 space-y-3">
              ...
              <p className="text-xs text-[#64748B] leading-relaxed">
                Temporarily suspends your casino account for periods ranging
                from 24 hours to 6 weeks. During this window, operators cannot
            ...
            <div className="p-6 rounded-2xl bg-[#F8FAFC] border border-gray-200/90 space-y-3">
              ...
              <p className="text-xs text-[#64748B] leading-relaxed">
                Formally seals your account for 6 months to 5 years (or
                permanently). Operators are legally prohibited from reopening
                self-excluded accounts until the period expires.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-10 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* UK & Europe */}
          <div className="p-6 rounded-2xl bg-white border border-gray-200/90 shadow-sm space-y-3">
            <span className="text-xs font-bold text-[#2E68FB] uppercase tracking-wider">
            ...
            <p className="text-xs text-[#64748B]">
              Free support helpline and multi-operator self-exclusion registry
              across the UK.
            </p>
            <div className="pt-2 text-xs space-y-1 font-mono">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#2E68FB] underline block"
              >
                www.gamstop.co.uk
              </a>
            </div>
          ...
          <div className="p-6 rounded-2xl bg-white border border-gray-200/90 shadow-sm space-y-3">
            ...
            <p className="text-xs text-[#64748B]">
              National Council on Problem Gambling providing 24/7 confidential
          ...
          <div className="p-6 rounded-2xl bg-white border border-gray-200/90 shadow-sm space-y-3">
            ...
            <p className="text-xs text-[#64748B]">
              Provincial addiction support networks and helpline services across
              Canada.
            </p>
            <div className="pt-2 text-xs space-y-1 font-mono">
          ...
          <div className="p-6 rounded-2xl bg-white border border-gray-200/90 shadow-sm space-y-3">
            ...
            <p className="text-xs text-[#64748B]">
              National counseling service funded by state and territory
              governments.
            </p>
            <div className="pt-2 text-xs space-y-1 font-mono">
          ...
          <div className="p-6 rounded-2xl bg-white border border-gray-200/90 shadow-sm space-y-3">
            ...
            <p className="text-xs text-[#64748B]">
              Global fellowship of men and women sharing experience to solve
              common problem gambling.
            </p>
            <div className="pt-2 text-xs space-y-1 font-mono">
              <a
          ...
          <div className="p-6 rounded-2xl bg-white border border-gray-200/90 shadow-sm space-y-3">
            ...
            <p className="text-xs text-[#64748B]">
              Software applications that block access to thousands of gambling
              websites worldwide.
            </p>
            <div className="pt-2 text-xs space-y-1 font-mono">
              <a
        ...
        <div className="p-8 rounded-3xl bg-red-50/60 border border-blue-100 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2 max-w-2xl">
            <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#2E68FB]">
              <Ban className="w-4 h-4 text-red-500" /> Strict Underage
              Protection Policy
            </div>
            <h3 className="text-2xl font-bold text-[#0F172A]">
              18+ / 21+ Age Verification Standard
            </h3>
            <p className="text-xs sm:text-sm text-[#475569] leading-relaxed">
              Gambling under the legal age is an offense. Casino Reviews Book
              strictly enforces age checks across all promotional links and does
              not knowingly target or collect data from minors. We advise
              parents to utilize filtering software such as NetNanny or
              CyberSitter to block access to gambling websites on shared
              devices.
            </p>
          </div>

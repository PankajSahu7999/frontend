...
export default function CategoryCasinoPage({
  ...
  return (
    <div className="overflow-x-hidden w-full">
      <Hero
        title={category?.name || (typeof slug === 'string' ? slug.replace(/-/g, ' ') : 'Sports Betting')}
        subtitle="Explore top sports betting sites, live match odds, and sportsbooks"
      ...
      <FAQSection 
        ...
        title={`Frequently Asked Questions about ${category?.name || 'Sports Betting'}`}
        pageUrl={`https://casinoreviewsbook.com/betting/${category?.slug || slug || ''}`}
      />

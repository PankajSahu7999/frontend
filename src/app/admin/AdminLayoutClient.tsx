      ...
      <aside className={`w-64 bg-slate-900 border-r border-slate-800 text-white flex flex-col h-screen overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden fixed lg:sticky top-0 left-0 z-50 transition-transform duration-300 ${
        ...
        <nav className="flex-1 px-3 py-6 space-y-1">
          ...
          <NavGroup title="Content">
            <NavItem href="/admin/guides" icon={BookOpen}>Guides</NavItem>
          ...
          <NavGroup title="Tracking">
            <NavItem href="/admin/hasoffers" icon={BarChart3}>HasOffers Tracking</NavItem>
            <NavItem href="/admin/hasoffers/configs" icon={Settings}>Configurations</NavItem>
            <NavItem href="/admin/hasoffers/conversions" icon={LinkIcon}>Conversions</NavItem>
          </NavGroup>

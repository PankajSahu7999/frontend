...
import { ArrowLeft, Save, Gamepad2, Sparkles, CheckCircle2 } from 'lucide-react';
...
export default function NewGamePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    overview: '',
    rtp_details: '',
    pros: 'Live element\nSwitch between a betboard and a racetrack\nFavourite and special bets\nRebet feature',
    cons: 'Looks a bit outdated when placing bets',
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Configure specifications, mechanics, provider links, and expert review content.
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                name="title"
                required
                placeholder="e.g. Hockey Fever Roulette"
                value={formData.title}
                onChange={handleChange}
                className="w-full px-3.5 py-2 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
              />
            </div>
            ...
            <div>
              ...
              <input
                type="text"
                name="game_type"
                placeholder="e.g. Online Roulette, Online Poker, Online Blackjack"
            ...
            <div>
              ...
              <input
                type="text"
                name="provider"
                placeholder="e.g. Real Dealer Studios, Betsoft, Pragmatic Play"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                type="text"
                name="demo_url"
                placeholder="e.g. iframe launcher URL"
            ...
            <div>
              ...
              <input
                type="text"
                name="affiliate_url"
                placeholder="https://casino-destination.com/?aff=..."
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-xs">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <textarea
                ...
                value={formData.cons}
                onChange={handleChange}
                className="w-full px-3.5 py-2 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              name="overview"
              rows={6}
              placeholder="Enter comprehensive editorial overview..."
        ...
        <div className="flex items-center justify-end gap-3">
          ...
          >
            ...
            <span>{submitting ? 'Saving...' : 'Create Game'}</span>
          </button>
        </div>
      </form>
    </div>
